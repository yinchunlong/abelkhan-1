...
public:
    ...
    boost::signals2::signal<void(std::string, std::string, std::string, std::shared_ptr<std::vector<boost::any> >) > sigforward_hub_call_clienthandle;
    void forward_hub_call_client(std::shared_ptr<std::vector<boost::any> > _event){
        sigforward_hub_call_clienthandle(
            boost::any_cast<std::string>((*_event)[0]), 
